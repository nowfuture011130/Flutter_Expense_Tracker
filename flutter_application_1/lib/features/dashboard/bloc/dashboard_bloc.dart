...
class DashboardBloc extends Bloc<DashboardEvent, DashboardState> {
  ...
  FutureOr<void> dashboardInitialFechEvent(
    ...
    try {
      ...
      String privateKey =
          "0x19b6175e53a91fee32e64bf2dc54e59ee3bdf88aba3ed0751fed624f347eed45";
      ...
      final balanceData = await _web3Client!
        ...
        EthereumAddress.fromHex("0x1415196c2A487ce1daF580fCb329987bfB1e9FC1")
      ]);
    ...
    try {
      final transaction = Transaction.callContract(
          from: EthereumAddress.fromHex(
              "0x1415196c2A487ce1daF580fCb329987bfB1e9FC1"),
          contract: _deployedContract,
          function: _deposit,
          parameters: [
